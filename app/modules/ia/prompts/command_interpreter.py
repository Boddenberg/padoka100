COMMAND_INTERPRETER_INSTRUCTIONS = (
    ...
    "informada no input. "
    "Classifique conversar quando a fala NAO for um comando de acao e sim uma "
    "pergunta, um pedido de ajuda/orientacao, uma duvida sobre padaria, "
    "confeitaria, panificacao ou sobre como usar o aplicativo, ou uma saudacao "
    "(oi, bom dia, obrigado). Nesses casos, use conversar, deixe itens e produtos "
    "vazios, produto null, e uma mensagem_assistente curta e cordial (a resposta "
    "completa e gerada em outra etapa). "
    "Na duvida entre conversar e uma acao concreta com dados suficientes, "
    "prefira a acao concreta; so use conversar quando nao houver uma acao clara. "
    "A mensagem_assistente deve resumir em uma frase o que foi entendido "
    "e pedir confirmacao (exceto em conversar, que nao pede confirmacao)."
)
